...
describe("validateAuth", () => {
	describe("valid tokens", () => {
		...
		it("should accept long tokens", async () => {
	...
	describe("missing or malformed headers", () => {
		...
		it("should reject 'Bearer' with no space", async () => {
	...
	describe("invalid tokens", () => {
		...
		it("should reject similar but not identical tokens", async () => {
	...
	describe("server misconfiguration", () => {
		it("should reject when MEMORY_AUTH_TOKEN is not set", async () => {
			const request = createRequest("Bearer test-token");
			const env = createMockEnv("");
